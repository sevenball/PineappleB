...
//        this(context, null);
    ...
    public LooperFrameLayout(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
    ...
    public LooperFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private TextView newTextView() {
        ...
        LayoutParams lp = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.CENTER_VERTICAL);
    ...
    private Animation newAnimation(float fromYValue, float toYValue) {
        Animation anim = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, fromYValue, Animation.RELATIVE_TO_SELF, toYValue);
